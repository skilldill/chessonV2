...
export function AnalysisEvaluationChart({
  ...
  return (
    <div className="w-full rounded-lg border border-white/10 bg-white/[0.04] p-3">
      <div className="mb-3 flex items-center justify-between gap-3">
        <div>
          <h2 className="text-base font-semibold text-white">{t("analysis.chart.title")}</h2>
          <p className="text-sm text-white/50">{t("analysis.chart.subtitle")}</p>
        </div>
        <div className="text-sm text-white/50">{t("analysis.chart.units")}</div>
      </div>
