...
const ProfileScreen: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-full flex justify-center overflow-y-auto px-4 py-6" style={{ height: window.innerHeight }}>
            ...
            <div className="flex flex-wrap gap-2">
              {Object.keys(CHESSBOARD_THEMES).map((themeKey) => (
                <button
                  ...
                  disabled={saving}
                  className={`rounded-lg  text-sm font-medium transition-all focus:outline-none touch-manipulation disabled:opacity-60 min-h-[44px] ${chessboardTheme === themeKey
